...
Prima dell'applicazione di questa soglia il dataset conteneva 781 imbarcazioni distinte (9.458.822 record). In seguito il numero di 
navi distinte è passato a 494 (9.383.271 righe), eliminando 287 vascelli (circa un terzo delle imbarcazioni di partenza) che costituivano 
solo lo 0,79\% dei record totali. 
...
consumo di memoria (il dataset occupa circa 708 MB nella rappresentazione di default)
...
in tabella. Grazie alle conversioni effettuate, il dataset si riduce da circa 708 MB a
circa 468 MB, con un risparmio prossimo al 33\%.
...
su 5.460.788 che ricadevano in quest'ultima casistica. 
...
\emph{stationary}, \emph{entry} o \emph{exit}, che rappresentano circa il 69,2\% del dataset totale.
...
La tabella risultante usata come input per l'applicazione dell'algoritmo di DBSCAN ha circa 54.000 righe, mentre il numero di 
punti stazionari processati è pari a circa 3.780.000 righe.
...
La tabella espansa conta circa 100.000 righe, ossia poco meno del doppio della tabella utilizzata come input per l'algoritmo DBSCAN\@. 

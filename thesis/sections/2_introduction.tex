...
% Non penso che questo sia il punto corretto dove metterlo
% \section{Storia e origine dell'AIS}
% AIS (Automatic Identification System) è un sistema automatico per il tracciamento della posizione
% delle imbarcazioni, la cui invenzione è attribuita a Benny Pettersson, che ne sviluppò il prototipo
% iniziale agli inizi degli anni 90.
% Nato con lo scopo di ridurre le collisioni in mare tra imbarcazioni, tale sistema divenne pian piano
% lo standard de facto fino al suo riconoscimento formale. L'International Maritime Organization (IMO) infatti
% ne rese obbligatoria l'installazione su tutte le navi passeggeri e su tutte le navi commerciali al di sopra
%  di una certa dimensione a partire dal 2004 \cite{imo2004}.

\section{Struttura della tesi}
Struttura della tesi.
\begin{itemize}
    \item Capitolo \ref{chap:literature} 
    \item Capitolo \ref{chap:methodology} 
    \item Capitolo \ref{chap:results} 
    \item Capitolo \ref{chap:conclusions} 
\end{itemize}